    ...
    <div className='about'>
      <div className='content'>
        ...
        <div className='text'>
          ...
          <a href='https://drive.google.com/file/d/1zdm5_QNzmrkofyZe_bcol2WIoljRoBgn/view?usp=sharing' className='cv-button' target='_blank' rel='noopener noreferrer'>Mi CV</a>
        </div>
      </div>
    </div>
  );
